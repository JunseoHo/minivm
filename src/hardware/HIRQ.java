...
public class HIRQ extends Event {
    ...
    public static final int REQUEST_IO_WRITE = 0x05;
    public static final int RESPONSE_IO_WRITE = 0x06;
    public static final int REQUEST_IO_READ = 0x07;
    public static final int RESPONSE_IO_READ = 0x08;
    public static final int COMPLETE_IO = 0x09;
    public static final int HALT = 0x0A;
    public static final int TIME_SLICE_EXPIRED = 0x0B;
